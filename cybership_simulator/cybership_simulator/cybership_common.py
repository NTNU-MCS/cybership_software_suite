...
class Simulator(Node):
    ...
    def __init__(self, eta0):
        ...
        self.subscriber_tunnel_thruster = self.create_subscription(Wrench, 'thruster/tunnel/command', self.cb_tunnel_thruster, 10)
        self.subscriber_starboard_thruster = self.create_subscription(Wrench, 'thruster/starboard/command', self.cb_starboard_thruster, 10)
        self.subcriber_port_thruster = self.create_subscription(Wrench, 'thruster/port/command', self.cb_port_thruster, 10)
